...
import com.kit.cn.library.db.ORM.extra.AutoIncrementTableColumn;
...
public class LightORM {
    public static final String TAG = "LightORM";

    private static Hashtable<String, LightORM> dbCache = new Hashtable<String, LightORM>();

    private String dbName;
    private SQLiteDatabase db;

    LightORM(String dbName, SQLiteDatabase db) {
        this.db = db;
        this.dbName = dbName;
    ...
    public static LightORM getInstance() {
        return getInstance(SQLiteBuilder.DEFAULT_DB);
    }

    public static LightORM getInstance(String dbName) {
...
//    }
    ...
    public static class ContentValueSetter {
        ...
        public void set(String key, Object value) {
            LightORM.bindContentValues(cv, key, value);
        }
