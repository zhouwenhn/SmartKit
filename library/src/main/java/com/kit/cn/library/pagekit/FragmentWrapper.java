...
public abstract class FragmentWrapper extends Fragment implements INewIntentAble {
    ...
    /**
     * openPage a new Fragment
     *
     * @param fragment fragment
     */
    public void openPage(@NonNull FragmentWrapper fragment) {
        getRootActivity().mManager.addFragment(this, fragment, null);
    }

    /**
     * openPage a new Fragment,And transfer parameters with bundle
     * <p>
     * Like this
     * <pre>   {@code
     ...
     * @param bundle   bundle
     */
    public void openPage(@NonNull FragmentWrapper fragment, Bundle bundle) {
        getRootActivity().mManager.addFragment(this, fragment, bundle);
    }

    /**
     * openPage a new Fragment,And transfer parameters with bundle andr set StackMode
     * Like this
     * <pre>   {@code
     * Bundle bundle=new Bundle();
     * bundle.put(key,value);
    ...
    public void openPage(@NonNull FragmentWrapper fragment, Bundle bundle, int stackMode) {
        getRootActivity().mManager.addFragment(this, fragment, bundle, stackMode);
    }
    ...
    public void dialogFragment(Fragment to) {
        getRootActivity().mManager.dialogFragment(to);
    }
    ...
    public void setDialogAnim(@AnimRes int dialog_in, @AnimRes int dialog_out) {
        getRootActivity().mManager.setDialogAnim(dialog_in, dialog_out);
    }
     ...
     */
    public void close() {
        getRootActivity().mManager.close(this);
    }
    ...
    public void close(FragmentWrapper fragment) {
        getRootActivity().mManager.close(fragment);
    }
     ...
     */
    public ActivityWrapper getRootActivity() {
