...
public class SQLiteBuilder {
    ...
    public SQLiteBuilder configDBName(String dbName) {
        this.dbName = dbName;

        return this;
    }

    public SQLiteBuilder configVersion(int version) {
        this.version = version;

        return this;
    }

    public SQLiteBuilder configSdcardPath(String path) {
        this.path = path;
        sdcardDb = true;
    ...
    public LightORM build(Context context) {
        SQLiteDatabase db;
