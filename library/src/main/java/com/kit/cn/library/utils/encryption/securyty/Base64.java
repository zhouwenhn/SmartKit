...
public class Base64 {
     ...
     */
    private final static byte[] WEBSAFE_ALPHABET  = { (byte) 'A', (byte) 'B', (byte) 'C', (byte) 'D', (byte) 'E', (byte) 'F', (byte) 'G', (byte) 'H', (byte) 'I', (byte) 'J', (byte) 'K', (byte) 'L',
            (byte) 'M', (byte) 'N', (byte) 'O', (byte) 'P', (byte) 'Q', (byte) 'R', (byte) 'S', (byte) 'T', (byte) 'U', (byte) 'V', (byte) 'W', (byte) 'X', (byte) 'Y', (byte) 'Z', (byte) 'a',
            (byte) 'b', (byte) 'c', (byte) 'd', (byte) 'e', (byte) 'f', (byte) 'g', (byte) 'h', (byte) 'i', (byte) 'j', (byte) 'k', (byte) 'l', (byte) 'm', (byte) 'n', (byte) 'o', (byte) 'p',
            (byte) 'q', (byte) 'r', (byte) 's', (byte) 't', (byte) 'u', (byte) 'v', (byte) 'w', (byte) 'x', (byte) 'y', (byte) 'z', (byte) '0', (byte) '1', (byte) '2', (byte) '3', (byte) '4',
    ...
    public static byte[] decode(byte[] source, int off, int len, byte[] decodabet) throws Exception {
        ...
        for (i = 0; i < len; i++) {
            ...
            if (sbiDecode >= WHITE_SPACE_ENC) { // White space Equals sign or
                ...
                if (sbiDecode >= EQUALS_SIGN_ENC) {
                    ...
                    if (sbiCrop == EQUALS_SIGN) {
                        ...
                        if (b4Posn == 0 || b4Posn == 1) {
                            ...
                            throw new Exception("padding byte '=' falsely signals end of encoded value " + "at offset " + i);
                ...
                throw new Exception("Bad Base64 input character at " + i + ": " + source[i + off] + "(decimal)");
            }
        }
